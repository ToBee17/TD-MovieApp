    ...
    <div className="flex flex-col items-center justify-center h-full mt-2">
        ...
        <div className="w-full h-full max-w-md mt-20">
            {results.length === 0 ? (
                    ...
                    <ScrollArea className="h-full w-full rounded-md mt-4" orientation="horizontal">
                        <div className="flex space-x-4">
                            {randomMovies.map((movie) => (
                                <div key={movie.id} className="mb-2 rounded flex-shrink-0" onClick={() => handleMovieClick(movie.id)}>
                ...
                results.map((result) => (
                    <div key={result.show.id} className="mb-2 p-2 text-white font-main rounded" onClick={() => handleMovieClick(movie.id)}>
